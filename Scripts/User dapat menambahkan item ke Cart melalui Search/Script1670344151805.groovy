...
Mobile.verifyElementExist(findTestObject('Add to Cart/android.widget.TextView - 899 USD'), 0)

Mobile.verifyElementExist(findTestObject('Add to Cart/android.widget.TextView - 5 item(s)'), 0)

Mobile.verifyElementExist(findTestObject('Add to Cart/android.widget.Button - ADD TO CART'), 0)

Mobile.tap(findTestObject('Object Repository/Add to Cart/android.widget.Button - ADD TO CART'), 0)

Mobile.waitForElementPresent(findTestObject('Add to Cart/android.widget.TextView - Number of order'), 2)

Mobile.verifyElementExist(findTestObject('Add to Cart/android.widget.TextView - Number of order'), 0)

Mobile.verifyElementExist(findTestObject('Add to Cart/android.widget.Button - CANCEL'), 0)

Mobile.verifyElementExist(findTestObject('Add to Cart/android.widget.Button - ADD'), 0)

Mobile.setText(findTestObject('Object Repository/Add to Cart/android.widget.EditText'), '1', 0)

Mobile.verifyElementText(findTestObject('Add to Cart/android.widget.EditText'), '1')
...
WebUI.callTestCase(findTestCase('User dapat mengecek halaman Shopping Cart'), [:], FailureHandling.STOP_ON_FAILURE)
